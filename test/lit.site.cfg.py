# Autogenerated from /Users/ash/dev/llvm-project/llvm/test/lit.site.cfg.py.in
# Do not edit!
...
config.host_triple = "x86_64-apple-darwin23.2.0"
config.target_triple = "x86_64-apple-darwin23.2.0"
...
config.python_executable = "/Library/Frameworks/Python.framework/Versions/3.11/bin/python3.11"
config.gold_executable = "/usr/bin/ld"
config.ld64_executable = "/Library/Developer/CommandLineTools/usr/bin/ld"
config.osx_sysroot = path(r"../../../../../Library/Developer/CommandLineTools/SDKs/MacOSX14.2.sdk")
...
config.llvm_host_triple = 'x86_64-apple-darwin23.2.0'
